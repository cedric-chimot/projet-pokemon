...
public class PokedexNationalService {
  ...
  public PokedexNational pokedexSave(String numDex, String nomPokemon, Integer idNature, Integer idDresseur,
      ...
      incrementerCompteurs(nature, dresseur, pokeball);
   ...
   * @param nature la nature à incrémenter
  ...
  private void incrementerCompteurs(Natures nature, Dresseurs dresseur, Pokeballs pokeball) {
    // Incrémentation des compteurs pour dresseur, pokeball, et nature
    dresseurService.incrementerNbPokemon(dresseur.getId());
    pokeballService.incrementerNbPokemon(pokeball.getId());
    natureService.incrementerNbPokemon(nature.getId());
  }

...
public class NatureService {
  ...
  /**
   * Méthode pour incrémenter le nombre de pokémon d'une nature donnée lorsqu'on ajoute un nouveau pokémon
   * @param natureId L'identifiant de la nature
   */
  public void incrementerNbPokemon(Integer natureId) {
